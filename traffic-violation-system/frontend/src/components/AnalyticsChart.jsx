...
export default function AnalyticsChart({ type, data }) {
  ...
  // 1. Line / Area Chart for daily violation counts
  if (type === 'area') {
    return (
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
          ...
          <Area type="monotone" dataKey="count" name="Violations" stroke="#aa3bff" strokeWidth={2} fillOpacity={1} fill="url(#colorVal)" />
        </AreaChart>
      </ResponsiveContainer>
    );
  }
