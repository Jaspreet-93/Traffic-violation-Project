...
export const evidenceAPI = {
  ...
  deleteEvidenceBulk: (ids) => API.delete('/api/v1/evidence/bulk', { data: { ids } }),
  deleteAllEvidence: () => API.delete('/api/v1/evidence'),
  getBulkDeleteProgress: (jobId) => API.get(`/api/v1/evidence/bulk/progress/${jobId}`),
